...
from dazero.utils import get_file, cache_dir
from dazero.transforms import Compose, Flatten, ToFloat, Normalize
...
class MNIST(Dataset):
    ...
    def prepare(self):
        url = 'https://github.com/konas122/DaZero/releases/tag/v1.1/'
